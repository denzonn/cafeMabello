...
@section('content')
        <div class="bg-white p-8 rounded-md text-gray-500">
            <div class="text-3xl font-semibold text-primary mb-4">Transaksi Belum Bayar</div>
            <div class="pt-4">
                <table id="unpaidTable" class="w-full">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let editUrl = '{{ route('transaction-detail', ':id') }}';
